 ...
 *
 * Duplicated here (from ask-user-question.mjs) intentionally — queue-processor.mjs
 * must not import from ask-user-question.mjs to avoid a circular dependency chain
 * (both are lib modules imported by the same event handler).
 *
